...
cp "$BRANDING_DIR/wappos-logo-white.png" "$DATA_DIR/wappos-logo-white.png"
cp "$BRANDING_DIR/wappos-favicon.png" "$DATA_DIR/wappos-favicon.png"
chown nextcloud:nextcloud "$DATA_DIR/wappos-logo-white.png" "$DATA_DIR/wappos-favicon.png"
